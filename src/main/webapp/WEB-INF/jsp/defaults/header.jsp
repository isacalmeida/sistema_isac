...
<link rel="icon" href="<c:url value='/assets/img/icon.png' />" />
...
<link rel="stylesheet" type="text/css" href="<c:url value='/assets/Ionicons/css/ionicons.min.css' />" />
<link rel="stylesheet" type="text/css" href="<c:url value='/assets/select2/css/select2.min.css' />" />
<link rel="stylesheet" type="text/css" href="<c:url value='/assets/morris/morris.css' />" />
<link rel="stylesheet" type="text/css" href="<c:url value='/assets/jquery-toast/jquery.toast.min.css' />" />
<link rel="stylesheet" type="text/css" href="<c:url value='/assets/jvectormap/jquery-jvectormap.css' />" />
<link rel="stylesheet" type="text/css" href="<c:url value='/assets/plugins/iCheck/square/blue.css' />" />
<link rel="stylesheet" type="text/css" href="<c:url value='/assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css' />" />
