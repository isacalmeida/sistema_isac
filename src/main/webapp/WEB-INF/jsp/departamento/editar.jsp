...
<div class="wrapper">
	...
	<div class="content-wrapper">
		<section class="content-header">
			<h1>
				Departamento
				<small>Cadastro de departamento dos produtos</small>
			</h1>
			<ol class="breadcrumb">
				...
				<form role="form" method="post" action='<c:url value="/departamento/salvar"/>'>
					<div class="box-header with-border">
						...
						<div class="form-group col-lg-12">
							...
							<input value="${departamento.codigo }" type="text" class="form-control" id="campoCodigo" disabled>
					...
					<div class="box-footer">
						<div class="col-xs-12 col-sm-10 col-md-8 col-lg-8">
							...
							<a href="<c:url value='/departamento' />"><button type="button" class="btn btn-default btn-flat">Voltar</button></a>
							<c:if test="${excluir != 1 }">
