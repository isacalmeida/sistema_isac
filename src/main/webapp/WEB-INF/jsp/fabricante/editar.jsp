	...
	<div class="content-wrapper">
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li><a href="<c:url value='/fabricante' />" >Fabricante</a></li>
				<li class="active">Editar</li>
			</ol>
		</section>
		<section class="content">
			<div class="box">
				<form role="form" method="post" action='<c:url value="/fabricante/salvar"/>'>
					<div class="box-header with-border">
						<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
							<label for="campoCriacao">Criado em:</label>
							<input type="datetime" id="campoCriacao" class="form-control" value="${fabricante.criacao }" disabled>
						</div>
						<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
							<label for="campoAlteracao">Última alteração em:</label>
							<input type="datetime" id="campoAlteracao" class="form-control" value="${fabricante.alteracao }" disabled>
						</div>
						<div class="form-group col-lg-12">
							<label for="campoCodigo">Codigo</label>
							<input value="${fabricante.codigo }" type="text" class="form-control" id="campoCodigo" disabled>
							<input value="${fabricante.codigo }" name="fabricante.codigo" type="hidden">
						</div>
					</div>
					<div class="box-body">
						<div class="form-group col-lg-12">
							<label for="campoDescricao">Descrição</label>
							<input value="${fabricante.descricao }" type="text" class="form-control" id="campoDescricao" name="fabricante.descricao">
						</div>
					</div>
					<div class="box-footer">
						<div class="col-xs-12 col-sm-10 col-md-8 col-lg-8">
							...
							<a href="<c:url value='/fabricante' />"><button type="button" class="btn btn-default btn-flat">Voltar</button></a>
							<c:if test="${excluir != 1 }">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<a href="<c:url value='/fabricante/${fabricante.codigo }/excluir'/>" ><button type="button" class="btn btn-primary" id="delete">Confirmar</button></a>
								</div>
							</div>
						</div>
					</div>
