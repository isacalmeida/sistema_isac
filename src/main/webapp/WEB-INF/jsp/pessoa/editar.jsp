						...
						<fieldset>
							<div class="row">
								<div class="form-group col-lg-12">
									...
									<input value="${pessoa.nome }" type="text" class="form-control" id="campoNome" name="nome">
								</div>
							</div>
							<div class="row">
								...
								<div class="modal-dialog modal-md">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a href="<c:url value='/pessoa/excluir?cod=${pessoa.codigo }'/>" ><button type="button" class="btn btn-primary" id="delete"> Confirmar </button></a>
										</div>
									</div>							
								</div>
							</div>
