				...
				<form role="form" method="post" action='<c:url value="/programas/salvar"/>'>
					<div class="box-header with-border">
						...
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<input value="${programa.codigo }" type="text" class="form-control" id="campoCodigo" disabled>
							<input value="${programa.codigo }" name="programa.codigo" type="hidden">
						</div>
					</div>
					<div class="box-body">
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div id="campoAtivo" class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<c:choose>
									<c:when test="${programa.ativo == true}">
										<input id="checkSwitch" name="programa.ativo" checked="checked" type="checkbox" data-on-text="Sim" data-off-text="Não" data-on-color="success" data-off-color="danger">
									</c:when>
									<c:when test="${programa.ativo == false}">
										<input id="checkSwitch" name="programa.ativo" type="checkbox" data-on-text="Sim" data-off-text="Não" data-on-color="success" data-off-color="danger">
									</c:when>
								</c:choose>
							</div>
						</div>
