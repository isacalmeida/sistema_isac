		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<h3 class="page-header"><span class="glyphicon glyphicon-chevron-right"></span> Cadastros </h3>
     		...
     		<div class="row">
     			...
     			<a href="<c:url value='/pessoa' />" ><button class="btn btn-success btn-lg col-sm-4"> Pessoa </button></a>
				<div class="col-sm-2"></div>
				<a href="<c:url value='/usuario' />" ><button class="btn btn-success btn-lg col-sm-4"> Usuario </button></a>
				<div class="col-sm-1"></div>
			</div>
		</div>
	</div>
